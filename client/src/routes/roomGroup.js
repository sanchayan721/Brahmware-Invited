...
import { EndIcon, MicIcon, VideoIcon } from '../assets/icons';
    ...
    return (
        <div class="row group-call">
            <div col="col-12">
                ...
                <div id ="button-box">
                    <button className="av" onClick = {toggleAudio}> <i class="mic-icon"><MicIcon/></i> </button>
                    <button className="end" onClick = {hangUp}> <i class="end-icon"></i> <EndIcon /></button>
                    <button className="avv" onClick = {toggleVideo}> <i class="video-icon"><VideoIcon /></i> </button>
                </div> 
