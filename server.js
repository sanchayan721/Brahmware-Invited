...
/* -------------- Creating Express Server and adding the middlewares ----------------- */
...
io.on("connection", socket => {
    ...
    socket.on("join room group", roomID => {
        ...
        if (users[roomID]) {
            ...
            // if 20 people have joined already, alert that room is full
            if (length === 200) {
...
// Creating and Joining Meeting store in MongoBD
app.use("/meeting", require('./routes'));
